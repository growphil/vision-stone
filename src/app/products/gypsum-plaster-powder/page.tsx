...
import GypsumPlasterClient from "@/components/products/GypsumPlasterClient";

export const metadata: Metadata = {
  title: "Gypsum Plaster Powder Manufacturer & Supplier in India | VISION STONES",
  description:
  ...
  openGraph: {
    title: "Gypsum Plaster Powder Manufacturer & Supplier | VISION STONES",
    description:
    ...
    images: [
      {
        url: "/Products/gypsum-plaster-powder.webp",
        width: 1200,
        height: 800,
        alt: "Vision Stones Gypsum Plaster Powder",
      },
    ],
  },
};

export default function GypsumPlasterPowderPage() {
  const product = getProductBySlug("gypsum-plaster-powder");

  // Related products from Gypsum category
  const relatedProducts = PRODUCTS.filter(
    (p) =>
      p.slug !== "gypsum-plaster-powder" &&
      (p.categorySlug === "gypsum" || p.category === "GYPSUM PRODUCTS")
  ).slice(0, 4);

  const faqs = [
    {
      question: "What is Gypsum Plaster Powder?",
      answer:
        "Gypsum Plaster Powder is a gypsum-based powder material used for plastering and finishing-related requirements. Specific product characteristics and suitability should be confirmed according to the intended application.",
    },
    {
      question: "Does Vision Stones supply Gypsum Plaster Powder?",
      answer:
        "Product-specific availability should be confirmed with Vision Stones based on the customer's requirement.",
    },
    {
      question: "Which industries can enquire about Gypsum Plaster Powder?",
      answer:
        "Construction and related project requirements can enquire about the product. Vision Stones also serves tiles & ceramics and general manufacturing customers. Specific product suitability should be confirmed for the intended application.",
    },
    {
      question: "Can I order Gypsum Plaster Powder in bulk?",
      answer:
    ...
    "@graph": [
      {
        ...
        description:
          "Vision Stones supplies mineral and raw-material products for customer-specific requirements. Gypsum Plaster Powder requirements can be discussed based on quantity, specification, application, packaging and delivery requirements.",
        image: "https://visionstones.in/Products/gypsum-plaster-powder.webp",
        brand: {
          "@type": "Brand",
          name: "Vision Stones",
        },
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#111111] font-display selection:bg-[#E52323] selection:text-white pt-24 sm:pt-32 pb-20">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-16 sm:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/contact?product=Gypsum%20Plaster%20Powder&intent=quote"
                ...
                <Link
                  href="/contact?product=Gypsum%20Plaster%20Powder"
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] rounded-[10px] overflow-hidden border border-[#E8E8E2] bg-[#1A1A1A] shadow-md group">
                <Image
                  src={product?.image || "/Products/gypsum-plaster-powder.webp"}
                  alt={product?.imageAlt || "Vision Stones Gypsum Plaster Powder"}
                  fill
                  priority
        ...
        {/* ========================================================
            2. WHAT IS GYPSUM PLASTER POWDER?
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
            What Is Gypsum Plaster Powder?
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
            <p>
              Gypsum Plaster Powder is a gypsum-based powder material used for plastering and finishing-related requirements.
            </p>
            <p>
        ...
        {/* ========================================================
            3. GYPSUM PLASTER POWDER PRODUCT INFORMATION
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Gypsum Plaster Powder Product Information
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Gypsum Plaster Powder requirements can vary according to the intended application and customer specifications.
            </p>
          </div>
        ...
        {/* ========================================================
            4. GYPSUM PLASTER POWDER APPLICATIONS & INDUSTRIES
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Gypsum Plaster Powder Applications &amp; Industries
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
              Gypsum Plaster Powder requirements should be discussed according to the intended application and required product specification.
            </p>
          </div>
            ...
            {[
              {
                sector: "01",
                name: "Construction",
                desc: "Construction is among the industries served by Vision Stones. Customers can discuss plastering and related raw-material requirements based on their project needs.",
                icon: HardHat,
              },
              {
                sector: "02",
                name: "General Manufacturing",
                desc: "Manufacturing businesses can enquire about Gypsum Plaster Powder based on their specific material requirements.",
                icon: Factory,
              },
              {
                sector: "03",
                name: "Industrial Requirements",
                desc: "Industrial and project customers can discuss quantity, specification, packaging and delivery requirements.",
                icon: Package,
              },
              {
                sector: "04",
                name: "Tiles & Ceramics",
                desc: "Vision Stones serves the tiles and ceramics industry. Customers can discuss applicable gypsum or mineral raw-material requirements according to their production needs.",
                icon: Building2,
              },
            ].map((ind, idx) => {
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F6] rounded-[10px] border border-[#E8E8E2] space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                The suitability of Gypsum Plaster Powder for a particular application should be confirmed based on the customer&apos;s specific requirements.
              </p>
            </div>
            ...
            <div className="p-4 bg-white rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
              ...
              <p>
                <strong className="text-[#111111]">Content note:</strong> The available Vision Stones source confirms a mineral/raw-material product portfolio and the industries served by the company, but does not provide Gypsum Plaster Powder-specific technical specifications or confirmed applications for each industry. Those details have therefore not been presented as confirmed product facts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
                Gypsum Plaster Powder Price in India
              </h2>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4 shadow-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>GET GYPSUM PLASTER POWDER PRICE</span>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Gypsum Plaster Powder Supply Based on Your Requirement
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Vision Stones supports small, bulk and industrial requirements depending on the product and customer requirement.
            </p>
            ...
            {[
              {
                ...
                desc: "Provide your Gypsum Plaster Powder requirement along with quantity, application and delivery location.",
              },
              {
                step: "02",
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Looking for Gypsum Plaster Powder Supply?
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
          ...
          <div className="p-4 bg-[#FAF9F6] rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
            <BadgeAlert className="w-4 h-4 text-[#888888] shrink-0 mt-0.5" />
            <p>
              <strong className="text-[#111111]">Source-safety note:</strong> The available Vision Stones source does not provide Gypsum Plaster Powder-specific purity, gypsum content, setting time, strength, particle-size ranges, certifications, packaging sizes or detailed technical application claims. These details have therefore not been presented as confirmed product facts.
            </p>
          </div>
        </section>
                ...
                >
                  <div className="space-y-3">
                    <div className="relative aspect-[4/3] rounded-[6px] overflow-hidden bg-[#FAF9F6]">
                      <Image
                        src={rel.image || "/Products/gypsum-plaster-powder.webp"}
                        alt={rel.imageAlt}
                        fill
