...
import RawMagnesiteClient from "@/components/products/RawMagnesiteClient";

export const metadata: Metadata = {
  title: "Raw Magnesite Powder Manufacturer & Supplier in India | VISION STONES",
  description:
  ...
  openGraph: {
    title: "Raw Magnesite Powder Manufacturer & Supplier | VISION STONES",
    description:
    ...
    images: [
      {
        url: "/Products/raw-magnesite-powder.webp",
        width: 1200,
        height: 800,
        alt: "Vision Stones Raw Magnesite Powder",
      },
    ],
  },
};

export default function RawMagnesitePowderPage() {
  const product = getProductBySlug("raw-magnesite-powder");

  // Related products from Calcium & Dolomite category
  const relatedProducts = PRODUCTS.filter(
    (p) =>
      p.slug !== "raw-magnesite-powder" &&
      (p.categorySlug === "calcium-dolomite" || p.category === "CALCIUM & DOLOMITE")
  ).slice(0, 4);

  const faqs = [
    {
      question: "What is Raw Magnesite Powder?",
      answer:
        "Raw Magnesite Powder is a powdered mineral raw material supplied according to customer and application requirements. Specific product characteristics should be confirmed according to the intended use.",
    },
    {
      question: "Does Vision Stones supply Raw Magnesite Powder?",
      answer:
        "Product-specific availability should be confirmed with Vision Stones based on the customer's requirement.",
    },
    {
      question: "Which industries can enquire about Raw Magnesite Powder?",
      answer:
    ...
    {
      question: "Can I order Raw Magnesite Powder in bulk?",
      answer:
    ...
    "@graph": [
      {
        ...
        description:
          "Vision Stones supplies mineral and raw-material products for customer-specific requirements. Raw Magnesite Powder requirements can be discussed based on quantity, specification, application, packaging and delivery requirements.",
        image: "https://visionstones.in/Products/raw-magnesite-powder.webp",
        brand: {
          "@type": "Brand",
          name: "Vision Stones",
        },
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#111111] font-display selection:bg-[#E52323] selection:text-white pt-24 sm:pt-32 pb-20">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-16 sm:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/contact?product=Raw%20Magnesite%20Powder&intent=quote"
                ...
                <Link
                  href="/contact?product=Raw%20Magnesite%20Powder"
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] rounded-[10px] overflow-hidden border border-[#E8E8E2] bg-[#1A1A1A] shadow-md group">
                <Image
                  src={product?.image || "/Products/raw-magnesite-powder.webp"}
                  alt={product?.imageAlt || "Vision Stones Raw Magnesite Powder"}
                  fill
                  priority
        ...
        {/* ========================================================
            2. WHAT IS RAW MAGNESITE POWDER?
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
            What Is Raw Magnesite Powder?
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
            <p>
              Raw Magnesite Powder is a powdered mineral raw material used according to the requirements of the customer and intended application.
            </p>
            <p>
              The exact characteristics, specification and suitability of Raw Magnesite Powder depend on the customer&apos;s requirement.
            </p>
            <p className="font-medium text-[#222222]">
              Vision Stones supplies mineral and raw-material products and discusses product requirements before confirming supply.
            </p>
          </div>
        </section>

        {/* ========================================================
            3. RAW MAGNESITE POWDER PRODUCT INFORMATION
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Raw Magnesite Powder Product Information
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Raw Magnesite Powder requirements can vary according to the intended application and customer specifications.
            </p>
          </div>
        ...
        {/* ========================================================
            4. RAW MAGNESITE POWDER APPLICATIONS & INDUSTRIES
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Raw Magnesite Powder Applications &amp; Industries
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
              Raw Magnesite Powder requirements should be discussed according to the intended application and required product specification.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Vision Stones serves agriculture and agri-input customers. Specific Raw Magnesite Powder suitability should be confirmed according to the intended use.",
                icon: Sprout,
              },
              {
                sector: "02",
                name: "Fertilizer & Agri-Inputs",
                desc: "Customers in fertilizer and agri-inputs can discuss their mineral raw-material requirements based on application and specification.",
                icon: Layers,
              },
              {
                sector: "03",
                name: "Rubber & Polymers",
                desc: "Vision Stones serves the rubber and polymers sector. Customers can discuss applicable mineral raw-material requirements.",
                icon: Layers,
              },
              {
                sector: "04",
                name: "Paints",
                desc: "Customers in the paints industry can discuss their required mineral raw materials, specification and quantity.",
                icon: Paintbrush,
              },
              {
                sector: "05",
                name: "Tiles & Ceramics",
                desc: "Vision Stones serves tiles and ceramics customers. Product suitability should be confirmed according to the specific production requirement.",
                icon: Building2,
              },
              {
                sector: "06",
                name: "Construction",
                desc: "Construction is among the industries served by Vision Stones. Customers can discuss their specific mineral raw-material requirements.",
                icon: HardHat,
              },
              {
                sector: "07",
                name: "Pipeline Applications",
                desc: "Vision Stones serves pipeline-related applications. Customers can share their specific material requirements for discussion.",
                icon: Pipette,
              },
              {
                sector: "08",
                name: "General Manufacturing",
                desc: "Manufacturing businesses can enquire about Raw Magnesite Powder based on their production and raw-material requirements.",
                icon: Factory,
              },
              {
                sector: "09",
                name: "Industrial Requirements",
                desc: "Industrial customers can discuss quantity, specification, packaging and delivery requirements.",
                icon: Package,
              },
            ].map((ind, idx) => {
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F6] rounded-[10px] border border-[#E8E8E2] space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                The suitability of Raw Magnesite Powder for a particular application should be confirmed based on the customer&apos;s specific requirements.
              </p>
            </div>
            ...
            <div className="p-4 bg-white rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
              ...
              <p>
                <strong className="text-[#111111]">Content note:</strong> The available Vision Stones source confirms the company&apos;s mineral/raw-material portfolio and industries served, but does not provide Raw Magnesite Powder-specific technical specifications or confirmed applications for each industry. Those details have therefore not been presented as confirmed product facts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
                Raw Magnesite Powder Price in India
              </h2>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4 shadow-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>GET RAW MAGNESITE POWDER PRICE</span>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Raw Magnesite Powder Supply Based on Your Requirement
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Vision Stones supports small, bulk and industrial requirements depending on the product and customer requirement.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-[8px] bg-[#FAF9F6] border border-[#E8E8E2] space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                Industrial customers can discuss their regular mineral raw-material requirements.
              </p>
            </div>
            ...
            {[
              {
                ...
                desc: "Provide your Raw Magnesite Powder requirement along with quantity, application and delivery location.",
              },
              {
                step: "02",
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Looking for Raw Magnesite Powder Supply?
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
          ...
          <div className="p-4 bg-[#FAF9F6] rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
            <BadgeAlert className="w-4 h-4 text-[#888888] shrink-0 mt-0.5" />
            <p>
              <strong className="text-[#111111]">Source-safety note:</strong> The available Vision Stones source does not provide Raw Magnesite Powder-specific chemical composition, purity, MgO content, moisture, particle-size ranges, certifications, packaging sizes or detailed technical application claims. These details have therefore not been presented as confirmed product facts.
            </p>
          </div>
        </section>
                ...
                >
                  <div className="space-y-3">
                    <div className="relative aspect-[4/3] rounded-[6px] overflow-hidden bg-[#FAF9F6]">
                      <Image
                        src={rel.image || "/Products/raw-magnesite-powder.webp"}
                        alt={rel.imageAlt}
                        fill
