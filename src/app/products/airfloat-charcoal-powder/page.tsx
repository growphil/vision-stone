...
import AirfloatCharcoalClient from "@/components/products/AirfloatCharcoalClient";

export const metadata: Metadata = {
  title: "Airfloat Charcoal Powder Manufacturer & Supplier in India | VISION STONES",
  description:
  ...
  openGraph: {
    title: "Airfloat Charcoal Powder Manufacturer & Supplier | VISION STONES",
    description:
    ...
    images: [
      {
        url: "/Products/airfloat-charcoal-powder.webp",
        width: 1200,
        height: 800,
        alt: "Vision Stones Airfloat Charcoal Powder",
      },
    ],
  },
};

export default function AirfloatCharcoalPowderPage() {
  const product = getProductBySlug("airfloat-charcoal-powder");

  // Related products from Charcoal category
  const relatedProducts = PRODUCTS.filter(
    (p) =>
      p.slug !== "airfloat-charcoal-powder" &&
    ...
    "@graph": [
      {
        ...
        image: "https://visionstones.in/Products/airfloat-charcoal-powder.webp",
        brand: {
          "@type": "Brand",
          name: "Vision Stones",
        },
      ...
      },
      {
        ...
        mainEntity: [
          {
            "@type": "Question",
            name: "What is Airfloat Charcoal Powder?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Airfloat Charcoal Powder is a charcoal-based powdered material. Specific product characteristics should be confirmed according to the intended application and customer requirement.",
            },
          },
          {
            "@type": "Question",
            name: "Does Vision Stones supply Airfloat Charcoal Powder?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Vision Stones includes charcoal and charcoal-related products within its product portfolio. Airfloat Charcoal Powder-specific availability should be confirmed based on the customer's requirement.",
            },
          },
          {
            "@type": "Question",
            name: "What industries can enquire about Airfloat Charcoal Powder?",
            acceptedAnswer: {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            name: "Can I order Airfloat Charcoal Powder in bulk?",
            acceptedAnswer: {
              "@type": "Answer",
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Yes. Customers can share their required specification, particle size where applicable, application and other technical requirements for discussion.",
            },
          },
          {
            "@type": "Question",
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#111111] font-display selection:bg-[#E52323] selection:text-white pt-24 sm:pt-32 pb-20">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-16 sm:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/contact?product=Airfloat%20Charcoal%20Powder&intent=quote"
                ...
                <Link
                  href="/contact?product=Airfloat%20Charcoal%20Powder"
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] rounded-[10px] overflow-hidden border border-[#E8E8E2] bg-[#1A1A1A] shadow-md group">
                <Image
                  src={product?.image || "/Products/airfloat-charcoal-powder.webp"}
                  alt={product?.imageAlt || "Vision Stones Airfloat Charcoal Powder"}
                  fill
                  priority
        ...
        {/* ========================================================
            2. WHAT IS AIRFLOAT CHARCOAL POWDER?
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
            What Is Airfloat Charcoal Powder?
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
            <p>
              Airfloat Charcoal Powder is a charcoal-based powdered material identified by the customer for a specific supply requirement.
            </p>
            <p>
            ...
            <p className="font-medium text-[#222222]">
              For Airfloat Charcoal Powder requirements, customers can share their intended application, quantity and required specifications with the Vision Stones team.
            </p>
          </div>
        </section>

        {/* ========================================================
            3. AIRFLOAT CHARCOAL POWDER PRODUCT INFORMATION
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Airfloat Charcoal Powder Product Information
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Airfloat Charcoal Powder requirements can vary according to the customer&apos;s intended application and purchasing requirements.
            </p>
          </div>
        ...
        {/* ========================================================
            4. AIRFLOAT CHARCOAL POWDER APPLICATIONS & INDUSTRIES
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Airfloat Charcoal Powder Applications &amp; Industries
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
              Airfloat Charcoal Powder requirements should be discussed according to the intended application and required product specifications. Vision Stones serves customers across multiple industries, including agriculture, fertilizer &amp; agri-inputs, rubber &amp; polymers, paints, tiles &amp; ceramics, construction, pipeline applications and general manufacturing.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Customers with agriculture-related raw-material requirements can discuss their charcoal-related requirements, intended application and quantity with Vision Stones.",
                icon: Sprout,
              },
              {
                sector: "02",
                name: "Fertilizer & Agri-Inputs",
                desc: "Vision Stones serves the fertilizer and agri-input sector. Customers can discuss any applicable charcoal-related requirement based on their intended use and product specification.",
                icon: Layers,
              },
              {
                sector: "03",
                name: "Rubber & Polymers",
                desc: "Customers in rubber and polymer-related industries can share their specific raw-material requirements, quantity and application for discussion.",
                icon: Layers,
              },
              {
                sector: "04",
                name: "Paints",
                desc: "Vision Stones serves customers in the paints sector. Any Airfloat Charcoal Powder requirement should be discussed according to the intended application and required specification.",
                icon: Paintbrush,
              },
              {
                sector: "05",
              ...
              },
              {
                sector: "06",
                name: "Construction",
                desc: "Construction is among the industries served by Vision Stones. Customers can share their specific material requirement and intended application for discussion.",
                icon: HardHat,
              },
              {
                sector: "07",
                name: "Pipeline Applications",
                desc: "Pipeline applications are included among the industries served by Vision Stones. Customers can discuss their specific raw-material requirements based on application and specification.",
                icon: Pipette,
              },
              {
                sector: "08",
                name: "General Manufacturing",
                desc: "Manufacturing customers can enquire about Airfloat Charcoal Powder based on their production or raw-material requirements.",
                icon: Factory,
              },
              {
                sector: "09",
                name: "Industrial Supply Requirements",
                desc: "Businesses with regular material requirements can discuss quantity, specifications, packaging and delivery requirements with Vision Stones.",
                icon: Package,
              },
            ].map((ind, idx) => {
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F6] rounded-[10px] border border-[#E8E8E2] space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                The suitability of Airfloat Charcoal Powder for a particular application should be confirmed according to the customer&apos;s specific requirement.
              </p>
            </div>
            ...
            <div className="p-4 bg-white rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
              ...
              <p>
                <strong className="text-[#111111]">Content note:</strong> The Vision Stones source confirms charcoal as part of the product portfolio and confirms the industries served by the company. It does not provide separate Airfloat Charcoal Powder-specific applications for each industry. Therefore, these should be confirmed before publishing technical application claims.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* ========================================================
            6. AIRFLOAT CHARCOAL POWDER PRICE
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
                Airfloat Charcoal Powder Price in India
              </h2>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4 shadow-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>GET AIRFLOAT CHARCOAL POWDER PRICE</span>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Airfloat Charcoal Powder Supply Based on Your Requirement
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Vision Stones supports small, bulk and industrial requirements, depending on the product and customer requirement.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-[8px] bg-[#FAF9F6] border border-[#E8E8E2] space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                Manufacturing and industrial customers can discuss their regular raw-material requirements.
              </p>
            </div>
            ...
            {[
              {
                ...
                desc: "Provide your Airfloat Charcoal Powder requirement along with quantity, application and delivery location.",
              },
              {
                step: "02",
        ...
        >
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="space-y-3">
                ...
                <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111] leading-tight">
                  Looking for Airfloat Charcoal Powder Supply?
                </h2>
              ...
              <div className="bg-[#FAF9F6] p-6 rounded-[8px] border border-[#E8E8E2] space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm text-[#444444]">
                  <div className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-[#E52323] rounded-full shrink-0" />
                    <span><strong>Product:</strong> Airfloat Charcoal Powder</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-[#E52323] rounded-full shrink-0" />
          ...
          <div className="pt-6 border-t border-[#E8E8E2]">
            <div className="p-4 sm:p-5 bg-[#FAF9F6] rounded-[6px] border border-[#E8E8E2] text-xs text-[#666666] leading-relaxed flex items-start gap-3">
              <BadgeAlert className="w-4 h-4 text-[#888888] shrink-0 mt-0.5" />
              <p>
                <strong className="text-[#111111]">Content note:</strong> The Vision Stones source confirms charcoal and charcoal-related products as part of the product portfolio, along with the industries served by the company. It does not provide Airfloat Charcoal Powder-specific technical specifications, grades, mesh sizes, carbon content, ash content, moisture, packaging sizes or confirmed industry-specific applications. Those details have therefore not been presented as confirmed product claims.
              </p>
            </div>
          </div>
        </section>
