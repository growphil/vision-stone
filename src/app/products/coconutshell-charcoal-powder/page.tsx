...
import CoconutshellCharcoalClient from "@/components/products/CoconutshellCharcoalClient";

export const metadata: Metadata = {
  title: "Coconutshell Charcoal Powder Manufacturer & Supplier in India | VISION STONES",
  description:
    "Vision Stones supplies charcoal and mineral/raw-material products for customer-specific requirements from Tirunelveli, Tamil Nadu. Small, bulk & industrial supply.",
  openGraph: {
    title: "Coconutshell Charcoal Powder Manufacturer & Supplier | VISION STONES",
    description:
      "Vision Stones supplies charcoal and mineral/raw-material products for customer-specific requirements. Manufacturing experience since 1997.",
    images: [
      {
        url: "/Products/coconutshell-charcoal-powder.webp",
        width: 1200,
        height: 800,
        alt: "Vision Stones Coconutshell Charcoal Powder",
      },
    ],
  },
};

export default function CoconutshellCharcoalPowderPage() {
  const product = getProductBySlug("coconutshell-charcoal-powder");

  // Related products from Charcoal category
  const relatedProducts = PRODUCTS.filter(
    (p) =>
      p.slug !== "coconutshell-charcoal-powder" &&
      (p.categorySlug === "charcoal" || p.category === "CHARCOAL PRODUCTS")
  ).slice(0, 4);

  const faqs = [
    {
      question: "What is Coconutshell Charcoal Powder?",
      answer:
        "Coconutshell Charcoal Powder is a charcoal-based powder material derived from coconut shell. Specific product characteristics and suitability should be confirmed according to the intended application.",
    },
    {
      question: "Does Vision Stones supply Coconutshell Charcoal Powder?",
      answer:
        "Vision Stones includes charcoal within its mineral and raw-material product portfolio. Coconutshell Charcoal Powder-specific availability should be confirmed based on the customer's requirement.",
    },
    {
      question: "Which industries can enquire about Coconutshell Charcoal Powder?",
      answer:
    ...
    {
      question: "Can I order Coconutshell Charcoal Powder in bulk?",
      answer:
    ...
    "@graph": [
      {
        ...
        description:
          "Vision Stones supplies charcoal and mineral/raw-material products for customer-specific requirements. Coconutshell Charcoal Powder requirements can be discussed based on quantity, specification, application, packaging and delivery requirements.",
        image: "https://visionstones.in/Products/coconutshell-charcoal-powder.webp",
        brand: {
          "@type": "Brand",
          name: "Vision Stones",
        },
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#111111] font-display selection:bg-[#E52323] selection:text-white pt-24 sm:pt-32 pb-20">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-16 sm:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/contact?product=Coconutshell%20Charcoal%20Powder&intent=quote"
                ...
                <Link
                  href="/contact?product=Coconutshell%20Charcoal%20Powder"
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] rounded-[10px] overflow-hidden border border-[#E8E8E2] bg-[#1A1A1A] shadow-md group">
                <Image
                  src={product?.image || "/Products/coconutshell-charcoal-powder.webp"}
                  alt={product?.imageAlt || "Vision Stones Coconutshell Charcoal Powder"}
                  fill
                  priority
        ...
        {/* ========================================================
            2. WHAT IS COCONUTSHELL CHARCOAL POWDER?
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
            What Is Coconutshell Charcoal Powder?
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
            <p>
              Coconutshell Charcoal Powder is a charcoal-based powder material derived from coconut shell and supplied for applicable customer and raw-material requirements.
            </p>
            <p>
              The exact product characteristics and suitability depend on the customer&apos;s intended application and required specification.
            </p>
            <p className="font-medium text-[#222222]">
              Vision Stones includes charcoal within its mineral and raw-material product portfolio and discusses customer requirements before confirming supply.
            </p>
          </div>
        </section>

        {/* ========================================================
            3. COCONUTSHELL CHARCOAL POWDER PRODUCT INFORMATION
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Coconutshell Charcoal Powder Product Information
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Coconutshell Charcoal Powder requirements can vary according to the intended application and customer specifications.
            </p>
          </div>
        ...
        {/* ========================================================
            4. COCONUTSHELL CHARCOAL POWDER APPLICATIONS & INDUSTRIES
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Coconutshell Charcoal Powder Applications &amp; Industries
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
              Coconutshell Charcoal Powder requirements should be discussed according to the intended application and required product specification.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Vision Stones serves agriculture and agri-input customers. Customers can discuss applicable charcoal or mineral raw-material requirements based on their intended use.",
                icon: Sprout,
              },
              {
                sector: "02",
                name: "Fertilizer & Agri-Inputs",
                desc: "Customers in the fertilizer and agri-input sector can discuss their raw-material requirements, quantity and specification.",
                icon: Layers,
              },
              {
                sector: "03",
                name: "Rubber & Polymers",
                desc: "Vision Stones serves customers in rubber and polymers. Customers can share their specific charcoal or raw-material requirement for discussion.",
                icon: Layers,
              },
              {
                sector: "04",
                name: "Paints",
                desc: "Customers in the paints sector can discuss applicable mineral or charcoal-related raw-material requirements with Vision Stones.",
                icon: Paintbrush,
              },
              {
                sector: "05",
                name: "Tiles & Ceramics",
                desc: "Vision Stones serves the tiles and ceramics industry. Customers can discuss applicable raw-material requirements according to their production needs.",
                icon: Building2,
              },
              {
                sector: "06",
                name: "Construction",
                desc: "Construction is among the industries served by Vision Stones. Customers can share their specific raw-material requirements for discussion.",
                icon: HardHat,
              },
              {
                sector: "07",
              ...
              },
              {
                ...
                desc: "Manufacturing businesses can enquire about Coconutshell Charcoal Powder based on their production and raw-material requirements.",
                icon: Factory,
              },
              {
                sector: "09",
                name: "Industrial Requirements",
                desc: "Industrial customers can discuss quantity, specification, packaging and delivery requirements for Coconutshell Charcoal Powder.",
                icon: Package,
              },
            ].map((ind, idx) => {
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F6] rounded-[10px] border border-[#E8E8E2] space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                The suitability of Coconutshell Charcoal Powder for a particular application should be confirmed based on the customer&apos;s specific requirements.
              </p>
            </div>
            ...
            <div className="p-4 bg-white rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
              ...
              <p>
                <strong className="text-[#111111]">Content note:</strong> The available Vision Stones source confirms charcoal within the product portfolio and the industries served by the company, but does not provide Coconutshell Charcoal Powder-specific technical specifications or confirmed applications for each industry. Those details have therefore not been presented as confirmed product facts.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* ========================================================
            6. COCONUTSHELL CHARCOAL POWDER PRICE
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
                Coconutshell Charcoal Powder Price in India
              </h2>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4 shadow-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>GET COCONUTSHELL CHARCOAL POWDER PRICE</span>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Coconutshell Charcoal Powder Supply Based on Your Requirement
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Vision Stones supports small, bulk and industrial requirements depending on the product and customer requirement.
            </p>
            ...
            {[
              {
                ...
                desc: "Provide your Coconutshell Charcoal Powder requirement along with quantity, application and delivery location.",
              },
              {
                step: "02",
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          ...
          <CoconutshellCharcoalClient faqs={faqs} />
        </section>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Looking for Coconutshell Charcoal Powder Supply?
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 bg-[#FAF9F6] p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4">
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-[#444444]">
                {[
                  "Product: Coconutshell Charcoal Powder",
                  "Required Quantity",
          ...
          <div className="p-4 bg-[#FAF9F6] rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
            <BadgeAlert className="w-4 h-4 text-[#888888] shrink-0 mt-0.5" />
            <p>
              <strong className="text-[#111111]">Source-safety note:</strong> The available Vision Stones source confirms charcoal within the product portfolio and the industries served by the company, but does not provide Coconutshell Charcoal Powder-specific carbon content, ash content, moisture, fixed carbon, mesh ranges, certifications, packaging sizes or detailed industry-specific applications. These details have therefore not been presented as confirmed product facts.
            </p>
          </div>
        </section>
                ...
                >
                  <div className="space-y-3">
                    <div className="relative aspect-[4/3] rounded-[6px] overflow-hidden bg-[#FAF9F6]">
                      <Image
                        src={rel.image || "/Products/coconutshell-charcoal-powder.webp"}
                        alt={rel.imageAlt}
                        fill
