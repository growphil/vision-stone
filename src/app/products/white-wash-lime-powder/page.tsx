...
import WhiteWashLimeClient from "@/components/products/WhiteWashLimeClient";

export const metadata: Metadata = {
  title: "White Wash Lime Powder Manufacturer & Supplier in India | VISION STONES",
  description:
  ...
  openGraph: {
    title: "White Wash Lime Powder Manufacturer & Supplier | VISION STONES",
    description:
    ...
    images: [
      {
        url: "/Products/white-wash-lime-powder.webp",
        width: 1200,
        height: 800,
        alt: "Vision Stones White Wash Lime Powder",
      },
    ],
  },
};

export default function WhiteWashLimePowderPage() {
  const product = getProductBySlug("white-wash-lime-powder");

  // Related products from Lime & Limestone category
  const relatedProducts = PRODUCTS.filter(
    (p) =>
      p.slug !== "white-wash-lime-powder" &&
      (p.categorySlug === "lime-limestone" || p.category === "LIME & LIMESTONE")
  ).slice(0, 4);

  const faqs = [
    {
      question: "What is White Wash Lime Powder?",
      answer:
        "White Wash Lime Powder is a lime-based powder material supplied for applicable customer and raw-material requirements. Specific product characteristics and suitability should be confirmed according to the intended application.",
    },
    {
      question: "Does Vision Stones supply White Wash Lime Powder?",
      answer:
        "Vision Stones includes lime within its mineral and raw-material product portfolio. White Wash Lime Powder-specific availability should be confirmed based on the customer's requirement.",
    },
    {
      question: "Which industries can enquire about White Wash Lime Powder?",
      answer:
        "Vision Stones serves agriculture, fertilizer & agri-inputs, paints, tiles & ceramics, construction and general manufacturing, among other industries. Specific product suitability should be confirmed for the intended application.",
    },
    {
      question: "Can I order White Wash Lime Powder in bulk?",
      answer:
    ...
    "@graph": [
      {
        ...
        description:
          "Vision Stones supplies lime and mineral/raw-material products for customer-specific requirements. White Wash Lime Powder requirements can be discussed based on quantity, specification, application, packaging and delivery requirements.",
        image: "https://visionstones.in/Products/white-wash-lime-powder.webp",
        brand: {
          "@type": "Brand",
          name: "Vision Stones",
        },
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#111111] font-display selection:bg-[#E52323] selection:text-white pt-24 sm:pt-32 pb-20">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-16 sm:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/contact?product=White%20Wash%20Lime%20Powder&intent=quote"
                ...
                <Link
                  href="/contact?product=White%20Wash%20Lime%20Powder"
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] rounded-[10px] overflow-hidden border border-[#E8E8E2] bg-[#1A1A1A] shadow-md group">
                <Image
                  src={product?.image || "/Products/white-wash-lime-powder.webp"}
                  alt={product?.imageAlt || "Vision Stones White Wash Lime Powder"}
                  fill
                  priority
        ...
        {/* ========================================================
            2. WHAT IS WHITE WASH LIME POWDER?
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
            What Is White Wash Lime Powder?
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
            <p>
              White Wash Lime Powder is a lime-based powder material supplied for applicable customer and raw-material requirements.
            </p>
            <p>
            ...
            <p className="font-medium text-[#222222]">
              Vision Stones includes lime within its mineral and raw-material product portfolio and discusses customer requirements before confirming supply.
            </p>
          </div>
        </section>

        {/* ========================================================
            3. WHITE WASH LIME POWDER PRODUCT INFORMATION
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              White Wash Lime Powder Product Information
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              White Wash Lime Powder requirements can vary according to the intended application and customer specifications.
            </p>
          </div>
        ...
        {/* ========================================================
            4. WHITE WASH LIME POWDER APPLICATIONS & INDUSTRIES
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              White Wash Lime Powder Applications &amp; Industries
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
              White Wash Lime Powder requirements should be discussed according to the intended application and required product specification.
            </p>
          </div>
            ...
            {[
              {
                sector: "01",
                name: "Construction",
                desc: "Construction is among the industries served by Vision Stones. Customers can discuss applicable lime-related raw-material requirements based on their intended use.",
                icon: HardHat,
              },
              {
                sector: "02",
                name: "Agriculture & Agri-Inputs",
                desc: "Vision Stones serves agriculture and agri-input customers. Customers can discuss their lime-related requirements, quantity and intended application.",
                icon: Sprout,
              },
              {
                sector: "03",
                name: "Fertilizer & Agri-Inputs",
                desc: "Customers in the fertilizer and agri-input sector can discuss applicable mineral and lime-related raw-material requirements.",
                icon: Layers,
              },
              {
                sector: "04",
                name: "Tiles & Ceramics",
                desc: "Vision Stones serves the tiles and ceramics industry. Customers can discuss applicable material requirements according to their production needs.",
                icon: Building2,
              },
              {
                sector: "05",
              ...
              },
              {
                ...
                desc: "Manufacturing businesses can enquire about White Wash Lime Powder based on their production and raw-material requirements.",
                icon: Factory,
              },
              {
                sector: "07",
                name: "Industrial Requirements",
                desc: "Industrial customers can discuss quantity, specification, packaging and delivery requirements for White Wash Lime Powder.",
                icon: Package,
              },
            ].map((ind, idx) => {
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F6] rounded-[10px] border border-[#E8E8E2] space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                The suitability of White Wash Lime Powder for a particular application should be confirmed based on the customer&apos;s specific requirements.
              </p>
            </div>
            ...
            <div className="p-4 bg-white rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
              ...
              <p>
                <strong className="text-[#111111]">Content note:</strong> The available Vision Stones source confirms lime within the product portfolio and confirms the industries served by the company. It does not provide White Wash Lime Powder-specific technical specifications or confirmed applications for each industry. Those details have therefore not been presented as confirmed product facts.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* ========================================================
            6. WHITE WASH LIME POWDER PRICE
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
                White Wash Lime Powder Price in India
              </h2>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4 shadow-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>GET WHITE WASH LIME POWDER PRICE</span>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              White Wash Lime Powder Supply Based on Your Requirement
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Vision Stones supports small, bulk and industrial requirements depending on the product and customer requirement.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-[8px] bg-[#FAF9F6] border border-[#E8E8E2] space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                Industrial customers can discuss their regular lime or mineral powder requirements.
              </p>
            </div>
            ...
            {[
              {
                ...
                desc: "Provide your White Wash Lime Powder requirement along with quantity, application and delivery location.",
              },
              {
                step: "02",
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Looking for White Wash Lime Powder Supply?
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 bg-[#FAF9F6] p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4">
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-[#444444]">
                {[
                  "Product: White Wash Lime Powder",
                  "Required Quantity",
          ...
          <div className="p-4 bg-[#FAF9F6] rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
            <BadgeAlert className="w-4 h-4 text-[#888888] shrink-0 mt-0.5" />
            <p>
              <strong className="text-[#111111]">Source-safety note:</strong> The available Vision Stones source confirms lime within the product portfolio and the industries served by the company, but does not provide White Wash Lime Powder-specific purity, CaO percentage, particle-size ranges, whiteness, certifications, packaging sizes or detailed application claims. These details have therefore not been presented as confirmed product facts.
            </p>
          </div>
        </section>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <h2 className="text-xl sm:text-2xl font-black uppercase tracking-tight text-[#111111]">
                  Related Lime &amp; Limestone Products
                </h2>
              </div>
              <Link
                href="/products?cat=lime-limestone"
                ...
                >
                  <div className="space-y-3">
                    <div className="relative aspect-[4/3] rounded-[6px] overflow-hidden bg-[#FAF9F6]">
                      <Image
                        src={rel.image || "/Products/white-wash-lime-powder.webp"}
                        alt={rel.imageAlt}
                        fill
