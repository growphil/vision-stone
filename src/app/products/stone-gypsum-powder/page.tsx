...
import StoneGypsumClient from "@/components/products/StoneGypsumClient";

export const metadata: Metadata = {
  title: "Stone Gypsum Powder Manufacturer & Supplier in India | VISION STONES",
  description:
  ...
  openGraph: {
    title: "Stone Gypsum Powder Manufacturer & Supplier | VISION STONES",
    description:
    ...
    images: [
      {
        url: "/Products/stone-gypsum-powder.png",
        width: 1200,
        height: 800,
        alt: "Vision Stones Stone Gypsum Powder",
      },
    ],
  },
};

export default function StoneGypsumPowderPage() {
  const product = getProductBySlug("stone-gypsum-powder");

  // Related products from Gypsum category
  const relatedProducts = PRODUCTS.filter(
    (p) =>
      p.slug !== "stone-gypsum-powder" &&
      (p.categorySlug === "gypsum" || p.category === "GYPSUM PRODUCTS")
  ).slice(0, 4);

  const faqs = [
    {
      question: "What is Stone Gypsum Powder?",
      answer:
        "Stone Gypsum Powder is a gypsum-based mineral powder product supplied for applicable customer and raw-material requirements. Specific product characteristics and suitability should be confirmed according to the intended application.",
    },
    {
      question: "Does Vision Stones supply Stone Gypsum Powder?",
      answer:
        "Product-specific availability should be confirmed with Vision Stones based on the customer's requirement.",
    },
    {
      question: "Which industries can enquire about Stone Gypsum Powder?",
      answer:
    ...
    {
      question: "Can I order Stone Gypsum Powder in bulk?",
      answer:
    ...
    "@graph": [
      {
        ...
        description:
          "Vision Stones supplies mineral and raw-material products for customer-specific requirements. Stone Gypsum Powder requirements can be discussed based on quantity, specification, application, packaging and delivery requirements.",
        image: "https://visionstones.in/Products/stone-gypsum-powder.png",
        brand: {
          "@type": "Brand",
          name: "Vision Stones",
        },
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-16 sm:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/contact?product=Stone%20Gypsum%20Powder&intent=quote"
                ...
                <Link
                  href="/contact?product=Stone%20Gypsum%20Powder"
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] rounded-[10px] overflow-hidden border border-[#E8E8E2] bg-[#1A1A1A] shadow-md group">
                <Image
                  src={product?.image || "/Products/stone-gypsum-powder.png"}
                  alt={product?.imageAlt || "Vision Stones Stone Gypsum Powder"}
                  fill
                  priority
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
            What Is Stone Gypsum Powder?
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
            <p>
              Stone Gypsum Powder is a gypsum-based mineral powder product supplied for applicable customer and raw-material requirements.
            </p>
            <p>
              The exact characteristics and suitability of Stone Gypsum Powder depend on the customer&apos;s intended application and required product specification.
            </p>
        ...
        {/* ========================================================
            3. STONE GYPSUM POWDER PRODUCT INFORMATION
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Stone Gypsum Powder Product Information
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Stone Gypsum Powder requirements can vary according to the intended application and customer specifications.
            </p>
          </div>
        ...
        {/* ========================================================
            4. STONE GYPSUM POWDER APPLICATIONS & INDUSTRIES
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Stone Gypsum Powder Applications &amp; Industries
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
              Stone Gypsum Powder requirements should be discussed according to the intended application and required product specification.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Vision Stones serves agriculture and agri-input customers. Customers can discuss applicable mineral raw-material requirements based on their intended use.",
                icon: Sprout,
              },
              {
                sector: "02",
                name: "Fertilizer & Agri-Inputs",
                desc: "Customers in the fertilizer and agri-input sector can discuss their mineral material requirements, quantity and specification.",
                icon: Layers,
              },
              {
                sector: "03",
              ...
              },
              {
                sector: "05",
                name: "Tiles & Ceramics",
                desc: "Vision Stones serves the tiles and ceramics industry. Customers can discuss mineral powder requirements according to their production needs.",
                icon: Building2,
              },
              {
                sector: "06",
              ...
              },
              {
                ...
                desc: "Manufacturing businesses can enquire about Stone Gypsum Powder based on their production and raw-material requirements.",
                icon: Factory,
              },
              {
                sector: "09",
                name: "Industrial Requirements",
                desc: "Industrial customers can discuss quantity, specification, packaging and delivery requirements for Stone Gypsum Powder.",
                icon: Package,
              },
            ].map((ind, idx) => {
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F6] rounded-[10px] border border-[#E8E8E2] space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                The suitability of Stone Gypsum Powder for a particular application should be confirmed based on the customer&apos;s specific requirements.
              </p>
            </div>
            ...
            <div className="p-4 bg-white rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
              ...
              <p>
                <strong className="text-[#111111]">Content note:</strong> The available Vision Stones source confirms a mineral/raw-material product portfolio and the industries served by the company, but does not provide Stone Gypsum Powder-specific technical specifications or confirmed applications for each industry. Those details have therefore not been presented as confirmed product facts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
                Stone Gypsum Powder Price in India
              </h2>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4 shadow-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>GET STONE GYPSUM POWDER PRICE</span>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Stone Gypsum Powder Supply Based on Your Requirement
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Vision Stones supports small, bulk and industrial requirements depending on the product and customer requirement.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-[8px] bg-[#FAF9F6] border border-[#E8E8E2] space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                Industrial customers can discuss their regular mineral powder requirements.
              </p>
            </div>
            ...
            {[
              {
                ...
                desc: "Provide your Stone Gypsum Powder requirement along with quantity, application and delivery location.",
              },
              {
                step: "02",
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Looking for Stone Gypsum Powder Supply?
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
          ...
          <div className="p-4 bg-[#FAF9F6] rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
            <BadgeAlert className="w-4 h-4 text-[#888888] shrink-0 mt-0.5" />
            <p>
              <strong className="text-[#111111]">Source-safety note:</strong> The available Vision Stones source does not provide Stone Gypsum Powder-specific purity, gypsum content, particle-size ranges, whiteness, moisture, certifications, packaging sizes or detailed industry-specific applications. These details have therefore not been presented as confirmed product facts.
            </p>
          </div>
        </section>
                ...
                >
                  <div className="space-y-3">
                    <div className="relative aspect-[4/3] rounded-[6px] overflow-hidden bg-[#FAF9F6]">
                      <Image
                        src={rel.image || "/Products/stone-gypsum-powder.png"}
                        alt={rel.imageAlt}
                        fill
