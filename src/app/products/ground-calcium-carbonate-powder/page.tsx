...
import GroundCalciumCarbonateClient from "@/components/products/GroundCalciumCarbonateClient";

export const metadata: Metadata = {
  title:
    "Ground Calcium Carbonate Powder Manufacturer & Supplier in India | VISION STONES",
  description:
  ...
  openGraph: {
    title:
      "Ground Calcium Carbonate Powder Manufacturer & Supplier | VISION STONES",
    description:
    ...
    images: [
      {
        url: "/Products/ground-calcium-carbonate-powder.webp",
        width: 1200,
        height: 800,
        alt: "Vision Stones Ground Calcium Carbonate Powder",
      },
    ],
  },
};

export default function GroundCalciumCarbonatePowderPage() {
  const product = getProductBySlug("ground-calcium-carbonate-powder");

  // Related products from Calcium & Dolomite category
  const relatedProducts = PRODUCTS.filter(
    (p) =>
      p.slug !== "ground-calcium-carbonate-powder" &&
      (p.categorySlug === "calcium-dolomite" ||
        p.category === "CALCIUM & DOLOMITE")
  ).slice(0, 4);

  const faqs = [
    {
      question: "What is Ground Calcium Carbonate Powder?",
      answer:
        "Ground Calcium Carbonate Powder is a mineral-based powder product used as a raw material in different industrial and manufacturing requirements. Specific suitability should be confirmed according to the intended application.",
    },
    {
      question: "Does Vision Stones supply Ground Calcium Carbonate Powder?",
      answer:
        "Vision Stones is a mineral manufacturing and supply company with a portfolio of mineral and raw-material products. Product-specific availability should be confirmed based on the customer's requirement.",
    },
    {
      question:
        "Which industries can enquire about Ground Calcium Carbonate Powder?",
      answer:
    ...
    {
      question: "Can I order Ground Calcium Carbonate Powder in bulk?",
      answer:
    ...
    "@graph": [
      {
        ...
        description:
          "Vision Stones supplies mineral and raw-material products for customer-specific requirements. Ground Calcium Carbonate Powder requirements can be discussed based on the required quantity, specification, application, packaging and delivery requirements.",
        image:
          "https://visionstones.in/Products/ground-calcium-carbonate-powder.webp",
        brand: {
          "@type": "Brand",
          name: "Vision Stones",
        },
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#111111] font-display selection:bg-[#E52323] selection:text-white pt-24 sm:pt-32 pb-20">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-16 sm:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/contact?product=Ground%20Calcium%20Carbonate%20Powder&intent=quote"
                ...
                <Link
                  href="/contact?product=Ground%20Calcium%20Carbonate%20Powder"
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] rounded-[10px] overflow-hidden border border-[#E8E8E2] bg-[#1A1A1A] shadow-md group">
                <Image
                  src={
                    product?.image ||
                    "/Products/ground-calcium-carbonate-powder.webp"
                  }
                  alt={
                    product?.imageAlt ||
                    "Vision Stones Ground Calcium Carbonate Powder"
                  }
                  fill
                  priority
        ...
        {/* ========================================================
            2. WHAT IS GROUND CALCIUM CARBONATE POWDER?
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
            What Is Ground Calcium Carbonate Powder?
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
            <p>
              Ground Calcium Carbonate Powder is a mineral-based powder product used as a raw material in different industrial and manufacturing requirements.
            </p>
            <p>
              The exact product specification and suitability can vary according to the customer&apos;s intended application and purchasing requirement.
            </p>
            <p className="font-medium text-[#222222]">
              Vision Stones supplies mineral and raw-material products to customers across multiple industries and discusses product requirements before confirming supply.
            </p>
          </div>
        </section>

        {/* ========================================================
            3. GROUND CALCIUM CARBONATE POWDER PRODUCT INFORMATION
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Ground Calcium Carbonate Powder Product Information
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Ground Calcium Carbonate Powder requirements can vary according to the intended application and customer specifications.
            </p>
          </div>
          ...
          <div className="p-4 sm:p-5 bg-white rounded-[8px] border-l-4 border-[#E52323] border border-[#E8E8E2] space-y-2">
            ...
            <p className="text-xs sm:text-sm text-[#666666] leading-relaxed">
              Where applicable, customers can discuss samples and technical information before confirming their requirement.
            </p>
          </div>
        </section>

        {/* ========================================================
            4. GROUND CALCIUM CARBONATE POWDER APPLICATIONS & INDUSTRIES
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Ground Calcium Carbonate Powder Applications &amp; Industries
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
              Ground Calcium Carbonate Powder requirements should be discussed according to the intended application and required product specification.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Vision Stones serves agriculture and agri-input customers. Customers can discuss their mineral raw-material requirements based on their intended application.",
                icon: Sprout,
              },
              {
                sector: "02",
                name: "Fertilizer & Agri-Inputs",
                desc: "Customers in the fertilizer and agri-input sector can enquire about applicable mineral requirements and discuss quantity, specification and delivery needs.",
                icon: Layers,
              },
              {
                sector: "03",
                name: "Rubber & Polymers",
                desc: "Vision Stones serves customers in rubber and polymers. Customers can share their specific raw-material requirement for discussion.",
                icon: Layers,
              },
              {
                sector: "04",
                name: "Paints",
                desc: "Customers in the paints sector can discuss their mineral and raw-material requirements with Vision Stones based on their application and required specification.",
                icon: Paintbrush,
              },
              {
                sector: "05",
                name: "Tiles & Ceramics",
                desc: "Vision Stones serves the tiles and ceramics industry. Customers can discuss applicable mineral powder requirements according to their production needs.",
                icon: Building2,
              },
              {
                sector: "06",
              ...
              },
              {
                ...
                desc: "Vision Stones serves pipeline-related applications. Customers can discuss their specific material requirement and intended use.",
                icon: Pipette,
              },
              {
                sector: "08",
                name: "General Manufacturing",
                desc: "Manufacturing businesses can enquire about Ground Calcium Carbonate Powder based on their production and raw-material requirements.",
                icon: Factory,
              },
              {
                sector: "09",
                name: "Industrial Requirements",
                desc: "Industrial customers can discuss quantity, specification, packaging and delivery requirements for their mineral powder needs.",
                icon: Package,
              },
            ].map((ind, idx) => {
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F6] rounded-[10px] border border-[#E8E8E2] space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                The suitability of Ground Calcium Carbonate Powder for a particular application should be confirmed based on the customer&apos;s specific requirements.
              </p>
            </div>
            ...
            <div className="p-4 bg-white rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
              ...
              <p>
                <strong className="text-[#111111]">Content note:</strong> The source material confirms Vision Stones&apos; mineral product portfolio and the industries served by the company, but does not provide separate Ground Calcium Carbonate Powder-specific technical specifications or confirmed applications for each industry. Those details have therefore not been presented as confirmed product facts.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* ========================================================
            6. GROUND CALCIUM CARBONATE POWDER PRICE
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
                Ground Calcium Carbonate Powder Price in India
              </h2>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4 shadow-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>GET GROUND CALCIUM CARBONATE POWDER PRICE</span>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Ground Calcium Carbonate Powder Supply Based on Your Requirement
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 rounded-[8px] bg-[#FAF9F6] border border-[#E8E8E2] space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                Customers with smaller or initial requirements can discuss their quantity and packaging needs.
              </p>
            </div>
            ...
            <div className="p-6 rounded-[8px] bg-[#FAF9F6] border border-[#E8E8E2] space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                Industrial customers can discuss their regular mineral powder requirements with the Vision Stones team.
              </p>
            </div>
        ...
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-3">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                Different customers may require different specifications and supply arrangements. Vision Stones discusses the required details before confirming supply.
              </p>
            </div>
          </div>
        </section>
            ...
            {[
              {
                ...
                desc: "Provide your Ground Calcium Carbonate Powder requirement along with quantity, application and delivery location.",
              },
              {
                step: "02",
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          ...
          <GroundCalciumCarbonateClient faqs={faqs} />
        </section>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Looking for Ground Calcium Carbonate Powder Supply?
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 bg-[#FAF9F6] p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4">
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-[#444444]">
                {[
                  "Product: Ground Calcium Carbonate Powder",
                  "Required Quantity",
          ...
          <div className="p-4 bg-[#FAF9F6] rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
            <BadgeAlert className="w-4 h-4 text-[#888888] shrink-0 mt-0.5" />
            <p>
              <strong className="text-[#111111]">Content note:</strong> The source material confirms Vision Stones&apos; mineral product portfolio and the industries served by the company, but does not provide Ground Calcium Carbonate Powder-specific purity, calcium carbonate percentage, whiteness, mesh ranges, particle-size distribution, certifications, packaging sizes or detailed industry-specific applications. Those details have therefore not been presented as confirmed product facts.
            </p>
          </div>
        </section>
