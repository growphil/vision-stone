...
import LimestoneLumpsClient from "@/components/products/LimestoneLumpsClient";

export const metadata: Metadata = {
  title: "Limestone Lumps Manufacturer & Supplier in India | VISION STONES",
  description:
  ...
  openGraph: {
    title: "Limestone Lumps Manufacturer & Supplier | VISION STONES",
    description:
    ...
    images: [
      {
        url: "/Products/limestone-lumps.webp",
        width: 1200,
        height: 800,
        alt: "Vision Stones Limestone Lumps",
      },
    ],
  },
};

export default function LimestoneLumpsPage() {
  const product = getProductBySlug("limestone-lumps");

  // Related products from Lime & Limestone category
  const relatedProducts = PRODUCTS.filter(
    (p) =>
      p.slug !== "limestone-lumps" &&
      (p.categorySlug === "lime-limestone" || p.category === "LIME & LIMESTONE")
  ).slice(0, 4);

  const faqs = [
    {
      question: "What are Limestone Lumps?",
      answer:
        "Limestone Lumps are limestone-based raw material supplied in lump form. Specific product characteristics and suitability should be confirmed according to the intended application.",
    },
    {
      question: "Does Vision Stones supply Limestone Lumps?",
      answer:
        "Vision Stones includes limestone within its mineral and raw-material product portfolio. Limestone Lumps-specific availability should be confirmed based on the customer’s requirement.",
    },
    {
      question: "Which industries can enquire about Limestone Lumps?",
      answer:
    ...
    {
      question: "Can I order Limestone Lumps in bulk?",
      answer:
    ...
    "@graph": [
      {
        ...
        description:
          "Vision Stones supplies limestone and mineral/raw-material products for customer-specific requirements. Limestone Lumps requirements can be discussed based on quantity, specification, application, packaging and delivery requirements.",
        image: "https://visionstones.in/Products/limestone-lumps.webp",
        brand: {
          "@type": "Brand",
          name: "Vision Stones",
        },
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-16 sm:space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link
                  href="/contact?product=Limestone%20Lumps&intent=quote"
                ...
                <Link
                  href="/contact?product=Limestone%20Lumps"
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] rounded-[10px] overflow-hidden border border-[#E8E8E2] bg-[#1A1A1A] shadow-md group">
                <Image
                  src={product?.image || "/Products/limestone-lumps.webp"}
                  alt={product?.imageAlt || "Vision Stones Limestone Lumps"}
                  fill
                  priority
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
            What Is Limestone Lumps?
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
            <p>
              Limestone Lumps are limestone-based raw material supplied in lump form for applicable customer and industrial requirements.
            </p>
            <p>
              The exact product characteristics and suitability depend on the customer’s intended application and required product specification.
            </p>
        ...
        {/* ========================================================
            3. LIMESTONE LUMPS PRODUCT INFORMATION
            ======================================================== */}
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Limestone Lumps Product Information
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Limestone Lumps requirements can vary according to the intended application and customer specifications.
            </p>
          </div>
        ...
        {/* ========================================================
            4. LIMESTONE LUMPS APPLICATIONS & INDUSTRIES
            ======================================================== */}
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Limestone Lumps Applications &amp; Industries
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-4xl">
              Limestone Lumps requirements should be discussed according to the intended application and required product specification.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Vision Stones serves agriculture and agri-input customers. Customers can discuss applicable limestone-related raw-material requirements based on their intended use.",
                icon: Sprout,
              },
              {
                sector: "02",
              ...
              },
              {
                ...
                desc: "Vision Stones serves customers in rubber and polymers. Customers can share their specific limestone or raw-material requirement for discussion.",
                icon: Layers,
              },
              {
                sector: "04",
              ...
              },
              {
                ...
                desc: "Manufacturing businesses can enquire about Limestone Lumps based on their production and raw-material requirements.",
                icon: Factory,
              },
              {
                sector: "09",
                name: "Industrial Requirements",
                desc: "Industrial customers can discuss quantity, specification, packaging and delivery requirements for Limestone Lumps.",
                icon: Package,
              },
            ].map((ind, idx) => {
          ...
          <div className="p-6 sm:p-8 bg-[#FAF9F6] rounded-[10px] border border-[#E8E8E2] space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-[#555555] leading-relaxed">
                The suitability of Limestone Lumps for a particular application should be confirmed based on the customer’s specific requirements.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {[
                  ...
                  "Required quantity",
                  "Specification / lump size, if applicable",
        ...
        <section className="bg-[#FAF9F6] rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
                Limestone Lumps Price in India
              </h2>
            ...
            <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[10px] border border-[#E8E8E2] space-y-4 shadow-sm">
              ...
              <div className="pt-2">
                ...
                >
                  <span>GET LIMESTONE LUMPS PRICE</span>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Limestone Lumps Supply Based on Your Requirement
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
              Vision Stones supports small, bulk and industrial requirements depending on the product and customer requirement.
            </p>
            ...
            {[
              {
                ...
                desc: "Provide your Limestone Lumps requirement along with quantity, application and delivery location.",
              },
              {
                step: "02",
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          ...
          <LimestoneLumpsClient faqs={faqs} />
        </section>
        ...
        <section className="bg-white rounded-[12px] border border-[#E8E8E2] p-6 sm:p-10 lg:p-12 space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-[#111111]">
              Looking for Limestone Lumps Supply?
            </h2>
            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-3xl">
          ...
          <div className="p-4 bg-[#FAF9F6] rounded-[6px] border border-[#E0E0DB] text-xs text-[#666666] leading-relaxed flex items-start gap-2.5">
            ...
            <p>
              <strong className="text-[#111111]">Source-safety note:</strong> The available Vision Stones source confirms limestone within the product portfolio and the industries served by the company, but does not provide Limestone Lumps-specific purity, calcium carbonate percentage, lump-size ranges, hardness, colour, certifications, packaging sizes or detailed industry-specific applications. These details have therefore not been presented as confirmed product facts.
            </p>
          </div>
        </section>
                ...
                >
                  <div className="space-y-3">
                    <div className="relative aspect-[4/3] rounded-[6px] overflow-hidden bg-[#FAF9F6]">
                      <Image
                        src={rel.image || "/Products/limestone-lumps.webp"}
                        alt={rel.imageAlt}
                        fill
