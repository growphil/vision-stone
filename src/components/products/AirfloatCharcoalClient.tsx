...
const FAQS: FAQItem[] = [
  {
    question: "What is Airfloat Charcoal Powder?",
    answer:
      "Airfloat Charcoal Powder is a charcoal-based powdered material. Specific product characteristics should be confirmed according to the intended application and customer requirement.",
  },
  {
    question: "Does Vision Stones supply Airfloat Charcoal Powder?",
    answer:
      "Vision Stones includes charcoal and charcoal-related products within its product portfolio. Airfloat Charcoal Powder-specific availability should be confirmed based on the customer's requirement.",
  },
  {
    question: "What industries can enquire about Airfloat Charcoal Powder?",
    answer:
  ...
  {
    question: "Can I order Airfloat Charcoal Powder in bulk?",
    answer:
...
export default function AirfloatCharcoalClient() {
